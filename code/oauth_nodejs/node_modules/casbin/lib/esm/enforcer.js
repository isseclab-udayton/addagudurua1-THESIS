...
export class Enforcer extends ManagementEnforcer {
     ...
     */
    async initWithFile(modelPath, policyPath) {
     ...
     */
    async initWithString(modelPath, policyString) {
     ...
     */
    async initWithAdapter(modelPath, adapter) {
     ...
     * @param adapter current adapter instance
     */
    async initWithModelAndAdapter(m, adapter) {
        if (adapter) {
